...
// (Tipos "enriquecidos" se mantienen igual)
...
      // 1. Si es WILDCARD, leemos de la prop 'approvedWildcards'
...
        return <p className="text-gray-600">No hay wildcards aprobados para evaluar en esta categoría.</p>
      }

      return relevantWildcards.map(wildcard => {
...
    // highlight-start
    // --- 2. LÓGICA RESTAURADA PARA PRELIMINAR ---
    // (Si no es WILDCARD, asumimos que es PRELIMINAR y usamos la lógica original)
...
// (Aquí había una llave '}' extra, que ha sido borrada)
// highlight-end