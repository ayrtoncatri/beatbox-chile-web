...
// Este archivo sirve como fallback cuando la API externa no está disponible
...
const COMUNAS_BY_REGION: Record<string, Comuna[]> = {
  ...
  "13": [ // Metropolitana
    ...
    { codigo: "13301", nombre: "Pudahuel (Maipú)" },
    { codigo: "13302", nombre: "Colina" },
    { codigo: "13303", nombre: "Lampa" },
    { codigo: "13304", nombre: "Tiltil" },
  ...
  "10": [ // Los Lagos
    ...
    { codigo: "10208", nombre: "Quemchi" },
    { codigo: "10209", nombre: "Quellón" },
...
export function getAllRegionesStatic(): Region[] {
  return [...REGIONES_STATIC];
}

export function getComunasByRegionCodigoStatic(codigoRegion: string): Comuna[] {
  return COMUNAS_BY_REGION[codigoRegion] || [];
}
